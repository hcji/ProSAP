...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.spinBoxMaxIt = QtWidgets.QSpinBox(Form)
        ...
        self.spinBoxBoost = QtWidgets.QSpinBox(Form)
        self.spinBoxBoost.setMinimum(2)
        self.spinBoxBoost.setMaximum(1000)
        self.spinBoxBoost.setProperty("value", 200)
        ...
        self.labelDatabase = QtWidgets.QLabel(Form)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.pushButtonShow = QtWidgets.QPushButton(Form)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
    ...
    def retranslateUi(self, Form):
        ...
        self.labelDatabase.setText(_translate("Form", "Result Table"))
