...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButtonTPP.setGeometry(QtCore.QRect(70, 340, 211, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(13)
        ...
        self.pushButtonTPCA.setGeometry(QtCore.QRect(340, 340, 211, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(13)
        self.pushButtonTPCA.setFont(font)
        self.pushButtonTPCA.setObjectName("pushButtonTPCA")
        self.pushButtonQC = QtWidgets.QPushButton(Form)
        self.pushButtonQC.setGeometry(QtCore.QRect(340, 220, 211, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(13)
        self.pushButtonQC.setFont(font)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButtonQC.setText(_translate("Form", "QC Analysis"))
